...
//
//*** Version .40 *** November 18, 2005 ***
//
//-housten, we have min/max!
//-computer takes 5 seconds just to look 2 moves ahead, and way to long for 3
//-also suffers horribly from "horizon effect"
//
//*** Things to add: ***
//
...
Chess.testString = "Computer's Score = " + Double.toString(bestScore);
		return bestMove;
	}
	double getScore(Node board, int d) {
		Move[] legalMoves = board.getAllMoves();
		if(d <= 0 || Array.getLength(legalMoves) == 0)
